        ...
        "/api/e621/media": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Encoded E621 media URL",
                        "name": "url",
                        "in": "query",
                        "required": true
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.E621Response"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
        ...
        "/api/e926/media": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Encoded E926 media URL",
                        "name": "url",
                        "in": "query",
                        "required": true
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.E926Response"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
